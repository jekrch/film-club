    ...
    return (
        <div className="py-4">
            ...
            <div className="flex justify-between items-center mb-4">
                {/* ... Title and Buttons ... */}
                {title && <h2 className="text-lg font-bold text-gray-200 mr-3">{title}</h2>}
                {!hideSizeButtons && (
                    <div className="flex items-center space-x-2">
                        ...
                        >
                            ...
                            <span className="sr-only">Poster View</span>
                        </Button>
                    </div>
                )}
            </div>
            ...
            {!hasContent ? (
                ...
                >
                    ...
                    {appendAllFilmsCard && (
                        <SwiperSlide
                            style={{ width: 'auto' }}
                            className={isPosterOnly ? '!w-48' : '!w-36'}
                        >
                            {' '}
                            {/* Set slide width */}
                ...
                <div className={`grid ${gridClasses} ${gapClass}`}>
                    ...
                    {appendAllFilmsCard && <AllFilmsCard cardSize={actualCardSize} />}
                </div>
            )}
        </div>
    );
