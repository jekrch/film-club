                ...
                the right and fading out toward the text — mirrors CreditsModal. */}
                        ...
                        <div className="relative z-10 flex justify-between items-center p-4 md:p-5 border-b border-slate-700/60">
                            <h2 className="text-base md:text-lg font-semibold text-slate-100 pr-4">
                                ...
                                <span className="text-amber-400">{letter}</span> doing there?
                            </h2>
                            <Button
                        ...
                        <div className="relative z-10 p-4 md:p-5 space-y-3 text-sm leading-relaxed text-slate-300">
                            <p>
                                ...
                                <span className="font-semibold text-amber-400">{letter}</span> is{' '}
                                {name}'s {medium} qualifier. For {name}, a {medium} score is only
                                comprehensible when understood in the context of the {medium}{' '}
                                medium.
                            </p>
                            <p>
                                Attempting to place a {medium} score alongside a score for an
                                ordinary film amounts to a category mistake: like ranking the flavor
                                of a given root beer against the ball-handling skills of a young
                                Michael Jordan.
                            </p>
                            <p>
                                To avoid any typological confusion, he has asked that you reflect on
                                this important qualification when you consider his score.
                            </p>
                        </div>
                    </div>
                </div>
