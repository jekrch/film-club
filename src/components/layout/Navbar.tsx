 ...
 */
const desktopLink = ({ isActive }: { isActive: boolean }) => classNames(
 ...
 */
const mobileLink = ({ isActive }: { isActive: boolean }) => classNames(
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center">
            <Link to="/" className="group flex items-center text-slate-300 hover:text-slate-100 transition-colors duration-200">
          ...
          <div className="md:hidden text-slate-300">
            <Hamburger size={20} toggled={isMenuOpen} toggle={setIsMenuOpen} label="Menu" />
          </div>
        </div>
      </div>
