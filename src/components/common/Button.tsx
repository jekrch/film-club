...
const SIZING: Record<ButtonVariant, Record<ButtonSize, string>> = {
  ...
  solid: { xs: 'px-3 py-1 text-xs gap-1', sm: 'px-4 py-1.5 text-sm gap-1.5', md: 'px-5 py-2 text-sm gap-2' },
  ghost: { xs: 'p-1.5', sm: 'p-2', md: 'p-2.5' },
  chip: { xs: 'px-3 py-1.5 text-[10px] gap-1.5', sm: 'px-3.5 py-2 text-xs gap-1.5', md: 'px-4 py-2 text-sm gap-2' },
};
...
const CHIP_STATE = {
  ...
  inactive: 'border-slate-600/70 bg-slate-800/40 text-slate-400 hover:border-slate-400 hover:text-slate-100 hover:bg-slate-700/40',
};
